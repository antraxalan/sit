...
var id_cliente;
        ...
        function queryDB_carrito(tx) {         
          tx.executeSql('select IdArt ,IdCli ,Calibre ,Empaque ,Precio ,Caja ,Unidad, CajasCamion, CodMarca, DesArt from TEMP_VENTA WHERE IdCli=?', [id_cliente], querySuccess_carrito, errorCB_list_carrito);
        }
