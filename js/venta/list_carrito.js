...
var id_cliente;
        ...
        function querySuccess_carrito(tx, results) { 
          ...
          var disabled;
          var precio_total=0;
          lista_contenido='<button type="button" class="btn_confirmar_ventas_global" data-theme="b">CONFIRMAR ORDEN<span class="ui-li-count total_carrito_val">0 Bs</span></button>';
