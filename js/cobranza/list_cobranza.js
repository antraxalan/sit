...
function queryDB_cobranza_last_sale(tx) {         
        ...
        function querySuccess_cobranza(tx, results) { 
          ...
          lista_contenido='<button type="button" class="class_confirmaciones btn_confirmar_cobranza" data-theme="b">CONFIRMAR COBRO<span style="box-shadow:2px 2px 4px 1px gray inset;" class="ui-li-count total_cobranza_val ui-page-theme-a">0 Bs</span></button>';
