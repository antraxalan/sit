...
function queryDB_todos_articulos(tx) {         
  tx.executeSql('select CodArt,TipoArticulo,CantxEmpaque,CodBotella,CodCaja from TEMPVENTA where IdCli=?', [id_cliente], querySuccess_deuda_articulos, errorCB_todos_articulos);
}
